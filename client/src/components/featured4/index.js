...
import fishChipsMenu from './fishChipsMenu.jpg';
            ...
            <Container fluid>
                <div id='contDiv'>
                    <div className='details'>
                        <h1 id='truckHeadMain1'>England Visits</h1>
                        <img src={placeHolder4} alt={'Feature truck'} id='detailsPic1' />



                        <h2 id='truckHead'>Menu: <img src={fishChipsMenu} alt={'Truck Menu'} id='menuPic1' /></h2>
